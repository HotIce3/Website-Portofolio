  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container-xl text-center py-20">
        ...
        {/* PERBAIKAN: Judul lebih besar dan leading-tight */}
        ...
        {/* PERBAIKAN: Paragraf lebih lebar (max-w-3xl) dan spasi baris lebih lega */}
        ...
        <div className="hero-cta flex flex-col sm:flex-row gap-6 justify-center items-center">
          <Link to="/menu" className="btn-primary w-full sm:w-auto text-lg">
            Lihat Menu Kami
          </Link>
          <Link
            to="/contact"
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
        <ChevronDown size={32} className="text-coffee-gold/70" />
      </div>
    </section>
  );
}

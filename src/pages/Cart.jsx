            ...
            <div className="lg:col-span-2">
              <div className="space-y-4">
                {cart.map((item) => (
                  <div
                    key={item.id}
                    className="bg-white dark:bg-coffee-dark rounded-lg p-6 flex gap-4 items-start coffee-shadow"
                  >
                    <img
                      src={item.image_url}
                      alt={item.name}
                    ...
                    <div className="flex-grow">
                      <h3 className="font-display text-lg font-bold text-coffee-dark dark:text-coffee-gold">
                        {item.name}
                      </h3>
                      <p className="text-sm text-coffee-dark dark:text-coffee-cream text-opacity-70 mb-3">
                        {item.category}
                      </p>
                      <p className="font-display text-lg font-bold text-coffee-gold">
                    ...
                    <div className="flex flex-col items-end gap-3">
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="px-2 py-1 bg-coffee-gold text-coffee-dark rounded hover:bg-coffee-dark hover:text-coffee-gold transition-all"
                        >
                          −
                        </button>
